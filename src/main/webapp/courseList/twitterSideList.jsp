		 				...
		 				<div class="col">
			 				<div class="card shadow-sm mb-5">
								...
								<ul class="list-group list-group-flush">
									<li class="list-group-item"><a href="../courseList/twitterVideoView.do?tnum=1">##1.1 🚨 Read this First 🚨 </a></li>
	 								<li class="list-group-item"><a href="../courseList/twitterVideoView.do?tnum=2">#1.2 Welcome! (03:22)</a></li>
	 								<li class="list-group-item"><a href="../courseList/twitterVideoView.do?tnum=3">#1.3 Requirements (01:11)</a></li>
	 								<li class="list-group-item"><a href="../courseList/twitterVideoView.do?tnum=4">#1.4 What is Firebase (06:27)</a></li>
	 								<li class="list-group-item"><a href="../courseList/twitterVideoView.do?tnum=5">#1.5 When to use Firebase (04:15)</a></li>
	 								<li class="list-group-item"><a href="../courseList/twitterVideoView.do?tnum=6">#1.6 Pricing in Firebase (04:12)</a></li>
								</ul>
