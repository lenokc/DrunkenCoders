...
<script type="text/javascript">
	...
	var rtn = 1;	// checkWrite에 전달될 값.
	function checkId(){
   		var id = $('#userid').val(); //id값이 "id"인 입력란의 값을 저장
    	$.ajax({
       		url:'../member/checkId.do', //Controller에서 인식할 주소
			...
			<article class="card-body mx-auto" style="max-width: 400px;">
				<form action="../member/memberWrite.do" name="writeForm" method="post" onsubmit="checkWrite();return false;">
					...
					<div class="form-group input-group" style="text-align:center;">
						...
						<input id="userid" name="userid" class="form-control" placeholder="Email address" type="email" required oninput = "checkId()">
					</div>
					<div>
						<span class="text-center id_ok">사용 가능한 아이디입니다.</span>
						<span class="text-center id_already">누군가 이 아이디를 사용하고 있어요.</span>
					</div>
					...
					<div class="form-group input-group" style="text-align:center;">
						...
						<input class="form-control" id="pwd" name="pwd" placeholder="Create password" type="password">
					</div>
				...
				<div style="text-align:center;">
					<p class="text-center">
						Have an account? <a href="${pageContext.request.contextPath}/member/memberLoginForm.do">Log In</a>
					</p>
