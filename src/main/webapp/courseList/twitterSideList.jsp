...
<html lang="en">
	...
	<body>	 		
		 	...
		 	------------------------------------------>
		 		<div class="col-lg-4 col-xl-3 mx-auto d-blcok d-lg-none topList" id="sideList">
		 			<div class="row">
		 	...
		 	------------------------------------------>
		 		<div class="col-lg-4 col-xl-3 mx-auto d-none d-lg-block scrollSide unlockList leftSideShow" id="sideList">
		 			<div class="row">
		 				<div class="card-body text-center mb-4 bg-white shadow-sm mx-auto text-dark">
		 					<h5 class="card-title disabled">트위터 클론코딩</h5>
		 					<div class="progress c-color-lightblue rounded-lg">
