			...
			<div class="row">
				<div class="jumbotron text-center col bg-white">
					<h1 class="display-3 font-weight-bold">
						<strong>트위터 클론코딩</strong>
					</h1>
					<h1 class="display-3 font-weight-bold text-primary">
						<strong> React Firebase for Beginners</strong>
					</h1>
					<div class="my-4">
					...
					<a class="btn btn-primary btn-lg p px-5 shadow-sm" href="enrollTwttierFree.do"
						role="button" id="test">무료 수강하기 <!-- <i class="bi-alarm"></i> -->
