		...
		<!-- nav include -->
		   ...
		   <!-----------------------------------------
		 	 ...
		 	 <div class="container-fluid px-0 c-skew-5 bg-light">
		 	 	<div class="c-skew-minus-5 c-color-blue pt-5 mb-5">
		 	 		<div class="container">
		 	 			<div class="row">
		 	 				<div class="jumbotron text-center col c-color-blue pb-0 text-white">
		 	 					<div class="c-skew-plus-5">
		 	 						<h1 class="display-4 font-weight-bold">트위터 클론코딩</h1>
		 	 						<h4 class="display-5 mb-5">Javascript for Beginners</h4>
		 	 						<h4 class=" pt-2">
		 	 							<span class="badge badge-pill badge-warning text-white">초급</span>
		 	 							<span class="badge badge-pill badge-warning text-white">무료</span>
		 	 						</h4>
		 	 					</div>
		 	 				</div>
		 	 			</div>
		 	 	...
		 	 	<div class="container">
		 	 		<div class="row">
		 	 			<div class="col-lg-9">
								...
								<div class="container-fluid my-5 text-center" id="point3">
									<!-- Stack the columns on mobile by making one full-width and the other half-width -->
									<div class="row row-cols-1 row-cols-md-3 c-po-relative">
										<div class="col mb-4">
											<div class="card mb-1 bg-white shadow-lg c-rounded-xl text-center p-4">
												<h1 class="text-primary display-4 font-weight-bold">36개</h1>
												<h5 class="text-muted">동영상</h5>
											</div><!-- col-md-6 col-xl-3 mb-5 -->
										</div>	
										<div class="col mb-4">
											<div class="card mb-1 bg-white shadow-lg c-rounded-xl text-center p-4">
												<h1 class="text-primary display-4 font-weight-bold">4.2시간</h1>
												<h5 class="text-muted">강의 분량</h5>
											</div><!-- col-md-6 col-xl-3 mb-5 -->
										</div>
										<div class="col mb-4">	
											<div class="card mb-1 bg-white shadow-lg c-rounded-xl text-center p-4">
												<h1 class="text-primary display-4 font-weight-bold">초급</h1>
												<h5 class="text-muted">레벨</h5>
											</div><!-- col-md-6 col-xl-3 mb-5 -->
										</div>
									</div>
									<div class="row">
		 				 	  	<!-----------------------------------------
		 								md이하에서 생기는 affix-bottom
		 							------------------------------------------>
									 <!-- col-md-9 : .fixed-bottom => md이하 사이즈에만 보임 :: data-spy="affix" 속성을 가지면 data-offset-top에 설정한 만큼 스크롤 되었을 때 자동으로 .affix 클래스명을 가지게 되며, data-offset-bottom 에 설정한 만큼 스크롤 되었을 때 자동으로 .affix 클래스명이 사라집니다.-->
									 <div class="card col d-block d-lg-none text-left p-1 fixed-bottom">
									 	<div class="row">
									 		<!-- right free enroll card -->
									 		<div class="col px-5">
									 			<div class="text-center">
									 				<a type="button" class="px-5 c-rounded-xl btn btn-primary btn-lg mx-auto m-3 btn-block" href="${pageContext.request.contextPath}/courseList/enrollTwitterFree.do">무료 수강하기</a>
									 			</div>
									 		</div>
									 	</div>
									 </div>
								...
								<!-----------------------------------------
		 									course explain card
		 						------------------------------------------>
								<div class="container-fluid" id="courseExplain">
									<h3>실전형 코딩을 시작하세요</h3>
									...
									<div class="row align-items-center my-5">
										...
										<div class="order-lg-1 c-rounded-xl shadow-lg bg-white p-5">
								...
								<!-----------------------------------------
		 							 			provide 컨텐츠
		 				 		------------------------------------------>
			 				 <div class="container-fluid pt-2 c-skew-minus-5 p-0 c-mt-8" id="provide">
			 				 	<!--  provide contents 시작문구 -->
			 				 	<div class="container-fluid c-skew-plus-5 pb-1">
			 				 		<div class="container">
			 				 			<div class="row my-5">
			 				 				<div class="col mt-5">
			 				 	...
			 				 	<div class="row mx-0">
			 				 		<div class="col-6 col-lg-6 mb-4">
			 				 			<div class="card shadow-lg">
			 				 				<div class="card-header bg-white text-center font-weight-bold h5">배우는 이론</div>
			 				 		...
			 				 		<div class="col-6 col-lg-6 mb-4 d-flex">
			 				 			<div class="card shadow-lg">
			 				 				<div class="card-header bg-white text-center font-weight-bold h5">구현하는 기능</div>
			 				 				<div class="card-body bg-light h6 align-self-stretch mb-0 c-w-100 c-pr-7 d-flex">
			 				 					<ul class="list-unstyled">
			 				 						<li class="">&nbsp; Email, Google, Github, Social Authentication</li>
			 				 						<li class="">&nbsp; Tweet CRUD</li>
			 				 						<li class="">&nbsp; Protected Pages</li>
			 				 						<li class="">&nbsp; Profile Page</li>
			 				 						<li class="">&nbsp; File Upload</li>
			 				 						<li class="">&nbsp; Deploy</li>
			 				 						<li class="">&nbsp; API Key Security</li>
			 				 					</ul>
			 				 				</div>
			 				 			</div>
			 				 			<!-- card -->
			 				 		...
			 				 		<div class="col mb-4 d-flex">
			 				 			<div class="card">
			 				 				...
			 				 				<div class="card-body text-white h6 mb-0 bg-dark align-self-stretch c-pr-7 text-left">
			 			 				 		<pre class="text-white text-left h6 overflow-hidden">
{
	"<span class="text-warning">이름</span>":"<span class="c-text-mint">트위터 클론코딩</span>",
	"<span class="text-warning">섹션</span>":"<span class="c-text-mint">무엇을 사용하나요??</span>?",
	"<span class="text-warning">패키지</span>": [
	"<span class="c-text-mint">React</span>"
	"<span class="c-text-mint">React Hooks</span>"
	"<span class="c-text-mint">React Router</span>"
	"<span class="c-text-mint">Firebase</span>"
	"<span class="c-text-mint">Create React App</span>"
	"<span class="c-text-mint">Github Pages</span>"
	]
}
			 				 					</pre>
			 				 				</div>
			 				 ...
			 				 <!-- .container#skills -->
		 				 	  	...
		 				 	  	<div class="row py-5">
		 				 	  		<div class="mx-auto">
		 				 	  			<div class="embed-responsive embed-responsive-16by9">
		 				 	  				<iframe width="560" height="315" src="https://www.youtube.com/embed/cQimgQdTpeQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		 				 	  			</div>
		 				 	  		</div>
		 				 	  	</div>
		 				 	  </div>
		 				 	  ...
		 				 	  <div class="container-fluid px-0" id="welcome">
		 				 	  	<div class="c-skew-minus-5 mb-5 pt-1">
		 					...
		 					<!-----------------------------------------
		 				 	...
		 				 	<div class="container-fluid px-0 c-skew-5 bg-light" id="after">
		 				 		<div class="c-skew-minus-5 mb-5 pt-1 pb-5">
		 				 			<div class="container c-mt-8 c-skew-plus-5">
		 				 				...
		 				 				<div class="row my-5">
		 				 					...
		 				 					<div class="col-12 col-sm-6 d-flex align-items-center">
		 				 						<div class="embed-responsive embed-responsive-16by9">
		 				 							<iframe width="560" height="315" src="https://www.youtube.com/embed/gYidw6wOhGg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		 				 						</div>
		 				 					</div><!-- col-12 col-sm-6 d-flex align-items-center end -->
		 				 				</div>
		 				 				<!-- row end -->
		 				 			...
		 				 			<div class="container c-mt-8 c-skew-plus-5">
		 				 				<div class="row pb-5">
		 				 					<div class="col-8 mx-auto">
		 				 						<h2 class="font-weight-bold h4">파이어베이스 무료 강의! 트위터 클론코딩 입니다!</h2>
		 				 						<hr>
		 				 						<ul class="h6">
		 				 							<li class="">&nbsp; 리얼타임 CRUD + 유저 인증 + 파일 업로드 = 이 모든 것을 백엔드 없이? 그것이 바로 파이어베이스의 힘!</li>
		 				 							<li class="">&nbsp; 파이어베이스를 이 강의에서 제대로 배워갈 수 있습니다.</li>
		 				 							<li class="">&nbsp; 리액트 기초는 아셔야합니다. 리액트JS 기초 강의 수강한 후 이 강의를 수강하세요!</li>
		 				 							<li class="">&nbsp; 완성된 모습을 직접 확인해보세요.</li>
		 				 							<li class="">&nbsp; 한글자막 포함 100% 제작 완료 되었습니다. Enjoy!</li>
		 				 							<li class="">&nbsp; 완료된 결과물 ⭐️ <a href="#">최종 데모</a> ⭐️ 를 살펴보세요.</li>
		 				 						</ul>
		 				 						<hr class="c-hr-bold mb-4">
		 				 						<h2 class="font-weight-bold h4">이 강의는 책으로 출판 되었습니다 ❤</h2>
		 				 						<hr>
		 				 						<ul class="h6">
		 				 							<li class="">&nbsp; 엄청난 인기에 힘입어. 해당 강의는 책으로 출판되었어요!</li>
		 				 							<li class="">&nbsp; Do it! 클론 코딩 트위터 (2021년 8월)</li>
		 				 							<li class="">&nbsp; 니꼬샘이 직접 제작한 퀴즈, 코딩 과제를 하면서 진짜 내 지식으로 만드세요.</li>
		 				 							<li class="">&nbsp; 모르는 내용은 개발자 수만여명이 모인 노마드 커뮤니티에서 실시간으로 물어보면서 해결할 수 있어요.</li>
		 				 							<li class="">&nbsp; <a href="#">Yes24, 교보문고 등 전국 서점에서 만나보실 수 있어요!</a></li>
		 					...
		 					<!-----------------------------------------
		 								course curriculum
		 				 	------------------------------------------>
		 				 <div class="container-fluid c-mb-8 cardList" id="curri">
		 				 	<div class="row">
		 				 		<div class="col mt-5">
		 				 		...
		 				 		<div class="col-12 mx-auto">
		 				 			<div class="card shadow-sm">
		 				 				...
		 				 				<ul class="list-group list-group-flush" id="firstCard">
		 				 					<li class="list-group-item">🚨 Read this First 🚨<a href="#">Free Preview →</a></li>
		 				 		...
		 				 		<div class="col-12 mx-auto my-5">
		 				 			<div class="card shadow-sm">
		 				 				...
		 				 				<ul class="list-group list-group-flush">
		 				 					<li class="list-group-item"><span class="lock">#2.0 Using Firebase Auth (08:36)</span><a href="#">Watch now →</a></li>
		 				 					<li class="list-group-item"><span class="lock">#2.1 Login Form part One (07:57)</span><a href="#">Watch now →</a></li>
		 				 					<li class="list-group-item"><span class="lock">#2.2 Recap (04:04)</span><a href="#">Watch now →</a></li>
		 				 					<li class="list-group-item"><span class="lock">#2.3 const and let (09:45)</span><a href="#">Watch now →</a></li>
		 				 					<li class="list-group-item"><span class="lock">#2.4 Log In (10:36)</span><a href="#">Watch now →</a></li>
		 				 					<li class="list-group-item"><span class="lock">#2.5 Social Login (07:09)</span><a href="#">Watch now →</a></li>
		 				 					<li class="list-group-item"><span class="lock">#2.6 Log Out (06:37)</span><a href="#">Watch now →</a></li>
		 				 		...
		 				 		<div class="col-12 mx-auto my-5">
		 				 			<div class="card shadow-sm">
		 				 				...
		 				 				<ul class="list-group list-group-flush">
		 				 					...
		 				 					<li class="list-group-item"><span class="lock">#6.3 Security on Firebase (08:24)</span><a href="#">Watch now →</a></li>
		 				 					<li class="list-group-item"><span class="lock">#6.4 API Key Security (03:23)</span><a href="#">Watch now →</a></li>
		 				 				</ul>
		 				 			</div><!-- card end -->
		 				 		</div><!-- col-12 mx-auto -->
		 				 	</div>
						...
						<!-----------------------------------------
										rightSide의 affix 영역
							------------------------------------------>
						<!-- col-md-9 : .fixed-top =>lg이상 사이즈에만 보임 :: data-spy="affix" 속성을 가지면 data-offset-top에 설정한 만큼 스크롤 되었을 때 자동으로 .affix 클래스명을 가지게 되며, data-offset-bottom 에 설정한 만큼 스크롤 되었을 때 자동으로 .affix 클래스명이 사라집니다.-->
						<div class="col-lg-3 d-none d-lg-block">
							<div class="card c-rounded-xl text-left p-4" data-spy="affix" data-offset-top="300" data-offset-bottom="1900" id="myAffix">
								<div class="row">
									<!-- right free enroll card -->
									<div class="col">
										<span class="badge badge-pill badge-warning text-white">초급</span>
										<span class="badge badge-secondary text-white">#무료강의</span><br>
										<h6 class="my-3 font-weight-bold"><i class="fas fa-check-circle mr-2"></i>수강 난이도</h6>
										<p>초급 이상의 React.js 이해도 필요.</p>
										<h6 class="my-3 font-weight-bold"><i class="fas fa-check-circle mr-2"></i>구현하는 기능</h6>
										<p>Email, Google, Github</p>
										...
										<p>그 외 다수...</p>
										<div class="text-center">
											<a type="button" class="px-5 c-rounded-xl btn btn-primary btn-lg mx-auto px-1 my-2" href="${pageContext.request.contextPath}/courseList/enrollTwitterFree.do">무료 수강하기</a>
										</div>
									</div>
								</div>
							</div>
				...
				<!-----------------------------------------
							Start : affix가 끝나는 영역
				------------------------------------------>
				<div class="container-fluid px-0 c-color-orange c-pt-8 c-mb-8 c-bg-sky" id="start">
					<div class="container">
						<div class="row">
							<div class="col">
									...
									<div class="col-lg-5 mx-auto bg-light p-5 text-center d-flex justify-content-center">
										<div class="col-12 align-self-center">
											...
											<div class="row mb-3 d-block d-lg-none d-xl-none">
												<h1 class="font-weight-bold display-4 col-lg-8 ">지금 바로 시작 해보세요!</h1>

											</div>
											<div class="row mb-3 d-none d-lg-block d-xl-block">
												<div class="font-weight-bold display-5 col-lg-8 text-right d-inline h4 p-0">지금 바로 시작 해보세요!</div>

											</div>
											<a type="button" class="btn btn-primary btn-lg btn-block shadow-sm" href="${pageContext.request.contextPath}/courseList/enrollTwitterFree.do">무료 수강하기</a>
										</div>
									</div>
								</div>
							</div>
				...
				<!-----------------------------------------
 				...
 				<div class="container-fluid">
 					<div class="row c-mt-8">
 						<div class="col col-sm-12 col-md-10 mx-auto c-mb-8">
 							<h2 class="font-weight-bold h1 text-center my-5">자주하는 질문</h2>
 							<!-- accordion -->
 							<div class="accordion col-12 px-5" id="accordionExample">
 								<div class="card">
