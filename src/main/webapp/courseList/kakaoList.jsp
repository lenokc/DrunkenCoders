...
<!doctype html>
	...
	<body>
	 	...
	 	<!-----------------------------------------
	 				 course curriculum
	 	------------------------------------------>
	 	<div class="container-fluid mt-5 bg-light cardList"> 	
	 		<div class="row">
	 					...
	 					<div class="col-lg-8 mx-auto">
	 						<div class="card shadow-sm mb-5">
	 							...
	 							<ul class="list-group list-group-flush">
	 								<li class="list-group-item">#1.1 🚨 Read this First 🚨 <a href="../courseList/kakaoVideoLock.do">Free Preview →</a></li>
	 								<li class="list-group-item">#1.2 Welcome (01:49)<a href="../courseList/kakaoVideoLock.do">Free Preview →</a></li>
	 								<li class="list-group-item">#1.3 Software Requirements (03:55)<a href="../courseList/kakaoVideoLock.do">Free Preview →</a></li>
	 								<li class="list-group-item">#1.4 Join the Challenge (02:26)<a href="../courseList/kakaoVideoLock.do">Free Preview →</a></li>
	 								<li class="list-group-item">#1.5 What Makes a Website? (05:34)<a href="kakaoVideoLock.do">Free Preview →</a></li>
